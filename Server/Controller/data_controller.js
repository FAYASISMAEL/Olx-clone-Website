...
export async function post(req, res) {
  ...
  if (category == 'car') {
    ...
    const data = await postSchema.create({
      profilePicture, email, category, postImage: post, brand, description, name: carName, year, fuel, transmission, owners: noOfOwners, title: adTitle, km_driven: kmDriven, price, location: {
